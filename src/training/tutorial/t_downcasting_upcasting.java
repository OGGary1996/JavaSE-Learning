...
public class t_downcasting_upcasting {
    ...
    public static void main(String[] args){
        ...
        // 可以通过集合批量处理多个子类对象
       Animal.makeSound(animalDefault); // 调用之前的static method，因为在同一个class内 方法前面不用写class name
       ...
       Animal.makeSound(dog);
        ...
        Animal.makeSound(DOG); // 调用之前的static method，因为在同一个class内 方法前面不用写class name
